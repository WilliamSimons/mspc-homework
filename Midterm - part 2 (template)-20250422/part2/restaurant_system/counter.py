...
# Input: burger of type Burger
# Output: print message, only cosmetic
    ...
    def add_item(self, burger: Burger): # This is missing
        ...
        # Complete here
        self.burger = burger
        self.items.append({"name": burger.get_name(), "price": burger.get_price()}) # creates a dictionary stored in the list items
        print("your burger is complete")
...
# Output: total --> float
    ...
    def get_total(self)-> float: # This is missing
        ...
        # Complete here
        total = 0
        for burger in self.items:
            total += round(burger.get("price"),2)
        return total
